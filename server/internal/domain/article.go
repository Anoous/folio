...
type Article struct {
	...
	FavoriteUpdatedAt time.Time     `json:"favorite_updated_at"`
	ArchivedUpdatedAt time.Time     `json:"archived_updated_at"`
	ProgressUpdatedAt time.Time     `json:"read_progress_updated_at"`
