...
func (r *ArticleRepo) ListKnowledgeDocuments(ctx context.Context, userID string) ([]domain.KnowledgeDocument, error) {
...
func (r *ArticleRepo) BroadRecallKnowledgeDocuments(ctx context.Context, userID string, keywords []string, limit int) ([]domain.KnowledgeDocument, error) {
