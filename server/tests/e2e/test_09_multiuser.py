...
class TestMultiUser:
    ...
    def test_users_have_different_ids(self, base_url):
        """Two aliased test logins produce different user IDs."""
        c1 = FolioAPIClient(base_url)
        c2 = FolioAPIClient(base_url)
        d1 = test_login(c1, alias="iso-a")
        d2 = test_login(c2, alias="iso-b")
    ...
    def test_article_isolation(self, base_url):
        ...
        c1 = FolioAPIClient(base_url)
        c2 = FolioAPIClient(base_url)
        test_login(c1, alias="iso-art-a")
        test_login(c2, alias="iso-art-b")
    ...
    def test_tag_isolation(self, base_url):
        ...
        c1 = FolioAPIClient(base_url)
        c2 = FolioAPIClient(base_url)
        test_login(c1, alias="iso-tag-a")
        test_login(c2, alias="iso-tag-b")
    ...
    def test_task_isolation(self, base_url):
        ...
        c1 = FolioAPIClient(base_url)
        c2 = FolioAPIClient(base_url)
        test_login(c1, alias="iso-task-a")
        test_login(c2, alias="iso-task-b")
